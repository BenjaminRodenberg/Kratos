...
public:
    ...
    public:
        ...
        {
            KRATOS_DEBUG_ERROR_IF_NOT(mpCurrentProcessInfo != NULL) << "ProcessInfo is not set!" << std::endl;
            return *mpCurrentProcessInfo;
        }
        const Properties &GetMaterialProperties()
        {
            KRATOS_DEBUG_ERROR_IF_NOT(mpMaterialProperties != NULL) << "MaterialProperties is not set!" << std::endl;
            return *mpMaterialProperties;
        }
        const GeometryType &GetElementGeometry()
        {
            KRATOS_DEBUG_ERROR_IF_NOT(mpElementGeometry != NULL) << "ElementGeometry is not set!" << std::endl;
